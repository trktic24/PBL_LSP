...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(['role:admin,asesor,asesi'])->get('/fr-ia-05-a/{id_asesi}', [IA05Controller::class, 'showSoalForm'])->name('FR_IA_05_A');
    Route::middleware(['role:admin'])->post('/fr-ia-05-a/store-soal', [IA05Controller::class, 'storeSoal'])->name('ia-05.store.soal');
    Route::middleware(['role:asesi'])->post('/fr-ia-05-a/store-jawaban/{id_asesi}', [IA05Controller::class, 'storeJawabanAsesi'])->name('ia-05.store.jawaban');
    Route::middleware(['role:admin,asesor'])->get('/fr-ia-05-b', [IA05Controller::class, 'showKunciForm'])->name('FR_IA_05_B');
    Route::middleware(['role:admin'])->post('/fr-ia-05-b', [IA05Controller::class, 'storeKunci'])->name('ia-05.store.kunci');
    Route::middleware(['role:admin,asesor'])->get('/fr-ia-05-c/{id_asesi}', [IA05Controller::class, 'showJawabanForm'])->name('FR_IA_05_C');
    Route::middleware(['role:asesor'])->post('/fr-ia-05-c/store-penilaian/{id_asesi}', [IA05Controller::class, 'storePenilaianAsesor'])->name('ia-05.store.penilaian');
    ...
    Route::middleware(['role:admin'])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::resource('master/tuk', TukAdminController::class)->names([
            'index' => 'master_tuk', 'create' => 'add_tuk', 'store' => 'add_tuk.store',
            'edit' => 'edit_tuk', 'update' => 'update_tuk', 'destroy' => 'delete_tuk'
        ]);

        // Master Category
        Route::resource('master/category', CategoryController::class)->names([
            'index' => 'master_category', 'create' => 'add_category', 'store' => 'add_category.store',
            'edit' => 'edit_category', 'update' => 'update_category', 'destroy' => 'delete_category'
        ]);

        // Master Mitra
        Route::resource('master/mitra', MitraController::class)->names([
            'index' => 'master_mitra', 'create' => 'add_mitra', 'store' => 'add_mitra.store',
            'edit' => 'edit_mitra', 'update' => 'update_mitra', 'destroy' => 'delete_mitra'
        ]);

        // Master Berita
        Route::resource('master/berita', BeritaController::class)->names([
            'index' => 'master_berita', 'create' => 'add_berita', 'store' => 'add_berita.store',
            'edit' => 'edit_berita', 'update' => 'update_berita', 'destroy' => 'delete_berita'
        ]);

        // Master Asesi
        Route::resource('master/asesi', AsesiController::class)->names([
            'index' => 'master_asesi', 'create' => 'add_asesi', 'store' => 'add_asesi.store',
            'edit' => 'edit_asesi', 'update' => 'update_asesi', 'destroy' => 'delete_asesi'
        ]);
...
>>>>>>> 2445ede0c155306dbf711ff52813942b1d1dd5ad
