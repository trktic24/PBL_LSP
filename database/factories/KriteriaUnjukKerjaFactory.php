...
// [1] Panggil Model-mu (pastikan namanya bener)
use App\Models\Elemen;
use App\Models\KriteriaUnjukKerja;

use App\Models\MasterKriteriaUnjukKerja;
use Illuminate\Database\Eloquent\Factories\Factory;
use App\Models\MasterElemen; // <-- [FIX] Ganti nama modelnya jadi MasterElemen

/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\KriteriaUnjukKerja>
 */
class KriteriaUnjukKerjaFactory extends Factory
{
    /**
     * [FIX] Sesuaikan nama Model-mu di sini
     */
    ...
    public function definition(): array
    {
        ...
        $selectedKriteria = $this->faker->randomElement(self::$kriteriaData);

        return [
            // --- INI KUNCINYA ---
            // Panggil factory induknya (MasterElemen)
            // Ini akan OTOMATIS membuat 1 Elemen baru (dan semua induk di atasnya)
            // lalu pakai ID-nya untuk 'id_elemen'.
            'id_elemen' => Elemen::factory(),

            // --- Kolom Sesuai Migrasi ---
            'no_kriteria' => $selectedKriteria['no'],

            // [BARU] Kolom 'tipe' dari migrasi
            'tipe' => $this->faker->randomElement(['aktivitas', 'demonstrasi']),

            // [BARU] Kolom 'standar_industri_kerja' dari migrasi
            'standar_industri_kerja' => $this->faker->randomElement(['SKKNI', 'ISO 27001', 'Standar Perusahaan', null]),
    ...
    public function withNumber(string $number): static
    {
        ...
        return $this->state(
            fn(array $attributes) => [
                ...
                'kriteria' => $kriteria['text'] ?? $this->faker->sentence(),
            ],
        );
    }
}
