...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('data_sertifikasi_asesi', function (Blueprint $table) {
            ...
            $table->enum('tujuan_asesmen',['sertifikasi', 'PKT', 'rekognisi pembelajaran sebelumnya', 'lainnya'])->comment('Tujuan asesmen asesi');
            ...
            $table->enum('jawaban_mapa01', ['hasil pelatihan', 'pekerjaan', 'pelatihan'])->comment('Jawaban MAPA-01');
            ...
            $table->enum('saran_paket_pelatihan', ['ada', 'tidak ada'])->comment('Apakah ada saran yang diberikan oleh paket pelatihan terkait kebutuhan kandidat');
            ...
            $table->text('komentar_AK02');
            $table->text('catatan_asesi_AK03');
            ...
            $table->text('keterangan_AK05');
            $table->text('aspek_dalam_AK05');
            $table->text('catatan_penolakan_AK05');
            $table->text('saran_dan_perbaikan_AK05');
