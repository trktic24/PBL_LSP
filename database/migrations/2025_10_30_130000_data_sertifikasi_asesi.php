...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('data_sertifikasi_asesi', function (Blueprint $table) {
            ...
            $table->text('feedback_ia01')->nullable()->comment('Feedback dari IA01 mengenai proses asesmen kandidat')->nullable();
            ...
            $table->text('tindakan_lanjut_AK02')->nullable();
            $table->text('komentar_AK02')->nullable();
            $table->text('catatan_asesi_AK03')->nullable();
            ...
            $table->text('keterangan_AK05')->nullable();
            $table->text('aspek_dalam_AK05')->nullable();
            $table->text('catatan_penolakan_AK05')->nullable();
            $table->text('saran_dan_perbaikan_AK05')->nullable();
