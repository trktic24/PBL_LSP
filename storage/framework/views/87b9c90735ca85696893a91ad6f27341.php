...
<body class="bg-white overflow-hidden">
  ...
  <main class="flex h-screen w-full">
    ...
    <div class="w-full lg:w-1/2 h-full bg-white flex flex-col justify-center px-10 lg:px-20 relative select-none z-10 overflow-hidden">
      ...
      <img src="<?php echo e(asset('images/pixel.png')); ?>" class="pixel1"
        style="--px-size: 250px; --px-top: -50px; --px-right: -13px;">

      <div class="absolute top-4 left-6">
        <img src="<?php echo e(asset('images/Logo_LSP_No_BG.png')); ?>" class="w-24 drop-shadow">
      </div>
      ...
      <div class="form-container mx-auto shadow-2xl relative z-20">
        ...
        <form action="<?php echo e(route('login_admin.post')); ?>" method="POST" class="space-y-5">
          <?php echo csrf_field(); ?>

          <div class="flex flex-col w-full">
            <label class="text-sm font-medium text-gray-700 mb-1">Email Address</label>
            <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>"
              class="px-4 py-2 border rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all <?php $__errorArgs = ['email'];
...
$message = $__bag->first($__errorArgs[0]); ?>
            <span class="text-xs text-red-500 mt-1"><?php echo e($message); ?></span>
            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div class="flex flex-col w-full">
            ...
            <input id="password" type="password" name="password"
              class="px-4 py-2 border rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div class="flex justify-end items-center text-sm ">
            <a href="<?php echo e(route('forgot_pass')); ?>" class="text-blue-600 hover:text-blue-800 font-medium transition-colors mb-6">
              Lupa Password?
            </a>
          </div>
      ...
      <img src="<?php echo e(asset('images/pixel2.png')); ?>" class="pixel2"
    ...
    <div class="hidden lg:block w-1/2 h-full relative bg-cover bg-center select-none rounded-bl-[4%] rounded-tl-[4%] shadow-[-10px_0_30px_rgba(0,0,0,0.4)] z-20 overflow-hidden"
      style="background-image: url('<?php echo e(asset('images/gedung_gkt.jpg')); ?>');">
