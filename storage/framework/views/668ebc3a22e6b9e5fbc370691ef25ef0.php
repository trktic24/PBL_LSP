<?php $__env->startPush('meta'); ?>
    ...
    <meta property="og:image" content="<?php echo e(asset('images/Gedung Polines.jpg')); ?>">
    ...
    <meta property="twitter:image" content="<?php echo e(asset('images/Gedung Polines.jpg')); ?>">
...
<section class="relative min-h-screen flex items-center rounded-b-[4rem] overflow-hidden z-10 pb-20 shadow-2xl">
    ...
    <img src="<?php echo e(asset('images/Gedung Polines.jpg')); ?>"
        alt="Gedung Polines"
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!Auth::check() || !in_array(strtolower(Auth::user()->role->nama_role ?? ''), ['admin', 'asesor'])): ?>
            ...
            <div id="categoryButtons" class="inline-flex gap-4 w-fit px-4"> 
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button data-category="<?php echo e($category); ?>"
                           ...
                           <?php echo e($loop->first ? 'active-category' : 'inactive-category'); ?>
...
<section class="px-4 md:px-10 mb-16 relative min-h-[700px]">
    <div class="relative w-full max-w-7xl mx-auto">
        ...
        <div class="flex transition-transform duration-700 ease-in-out" id="gridSlides">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $chunks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex-none w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-6 px-4 skema-slide" data-slide-index="<?php echo e($index); ?>">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skema): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $imgSrc = $skema->gambar_url;
                            $categoryName = $skema->category?->nama_kategori ?? 'Tidak Terkategori';
                        ?>
                        
                        <div class="transition-all duration-300 hover:scale-[1.02] skema-card group" data-category="<?php echo e($categoryName); ?>">
                            <a href="<?php echo e(route('skema.detail', ['id' => $skema->id_skema])); ?>">
                            ...
                            <div class="px-2">
                                <h2 class="text-lg font-bold text-gray-800 mb-1 group-hover:text-blue-700 transition-colors"><?php echo e($skema->nama_skema); ?></h2>
                                <p class="text-xs text-gray-500 mb-2 font-medium"><?php echo e($categoryName); ?></p>
                                <p class="text-blue-600 font-bold text-lg">Rp <?php echo e(number_format($skema->harga, 0, ',', '.')); ?></p>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
    ...
    <div class="max-w-7xl mx-auto relative">
        ...
        <div class="overflow-hidden relative rounded-2xl">
            <div class="flex transition-transform duration-500 ease-in-out" id="jadwal-track">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $jadwalChunks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    
                    <div class="flex-none w-full grid grid-cols-1 md:grid-cols-3 gap-6 p-2">
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="card bg-white shadow-lg rounded-2xl border border-gray-100 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 h-full">
                                <div class="card-body flex flex-col p-6 text-left h-full">
                                    ...
                                    <h4 class="text-base font-bold text-gray-900 mb-4 h-12 line-clamp-2 leading-tight">
                                        <?php echo e($jadwal->skema?->nama_skema ?? 'Skema tidak ditemukan'); ?>
                                    ...
                                    <div class="mt-auto space-y-3 mb-6">
                                        <div>
                                            ...
                                            <p class="text-sm font-medium text-gray-700 truncate"><?php echo e($jadwal->masterTuk?->nama_lokasi ?? 'TUK tidak spesifik'); ?></p>
                                        </div>
                                        <div>
                                            <p class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-0.5">TANGGAL</p>
                                            <p class="text-sm font-medium text-gray-700"><?php echo e($jadwal->tanggal_pelaksanaan ? $jadwal->tanggal_pelaksanaan->format('d F Y') : 'TBA'); ?></p>
                                        </div>
                                    </div>

                                    <a href="<?php echo e(route('jadwal.detail', ['id' => $jadwal->id_jadwal])); ?>" 
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loop->last && $chunk->count() < 3): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 0; $i < (3 - $chunk->count()); $i++): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($jadwalChunks->count() > 1): ?>
    ...
    <div class="max-w-7xl mx-auto relative">
        ...
        <div class="overflow-hidden relative rounded-2xl">
            <div class="flex transition-transform duration-500 ease-in-out" id="berita-track">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $beritaChunks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    
                    <div class="flex-none w-full grid grid-cols-1 md:grid-cols-3 gap-6 p-2">
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $berita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="card bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:scale-[1.03] text-left h-full flex flex-col">
                                ...
                                <a href="<?php echo e(route('berita.detail', ['id' => $berita->id])); ?>" class="flex flex-col h-full"> 
                                    ...
                                    ?>
                                    <img src="<?php echo e($imgBerita); ?>" 
                                         alt="<?php echo e($berita->judul_berita); ?>" 
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($beritaChunks->count() > 1): ?>
