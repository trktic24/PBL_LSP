...
<?php endif; ?>
            ...
            <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div class="bg-white p-6 rounded-xl shadow-lg flex items-center border-b-4 border-blue-600/30 min-h-[200px]">
                    ...
                    <div class="relative flex-1 h-full flex items-center justify-center">
                        ...
                        <p class="text-5xl font-bold text-gray-900"><?php echo e($asesmenBerlangsung); ?></p>
                    </div>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-lg flex items-center border-b-4 border-green-600/30 min-h-[200px]">
                    ...
                    <div class="relative flex-1 h-full flex items-center justify-center">
                        ...
                        <p class="text-5xl font-bold text-gray-900"><?php echo e($asesmenSelesai); ?></p>
                    </div>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-lg flex items-center border-b-4 border-yellow-600/30 min-h-[200px]">
                    ...
                    <div class="relative flex-1 h-full flex items-center justify-center">
                        ...
                        <p class="text-5xl font-bold text-gray-900"><?php echo e($jumlahAsesi); ?></p>
                    </div>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-lg flex items-center border-b-4 border-red-600/30 min-h-[200px]">
                    ...
                    <div class="relative flex-1 h-full flex items-center justify-center">
                        ...
                        <p class="text-5xl font-bold text-gray-900"><?php echo e($jumlahAsesor); ?></p>
                    </div>
                    ...
                    <div class="flex justify-between items-start z-10 relative">
                        <div>
                            ...
                            <div class="flex items-baseline gap-2">
                                <h4 class="text-3xl font-bold text-gray-800"><?php echo e($asesiBaruHariIni ?? 0); ?></h4>
                                <span class="text-xs text-gray-500">Asesi</span>
                            </div>
                            <div class="mt-3 flex items-center text-sm font-medium <?php echo e(($trenPendaftaran ?? 0) >= 0 ? 'text-green-600' : 'text-red-500'); ?>">
                                <span class="flex items-center bg-white px-2 py-0.5 rounded-full shadow-sm">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($trenPendaftaran ?? 0) >= 0): ?>
                                        <i class="fas fa-arrow-trend-up mr-1.5"></i> +<?php echo e($trenPendaftaran ?? 0); ?>%
                                    <?php else: ?>
                                        <i class="fas fa-arrow-trend-down mr-1.5"></i> <?php echo e($trenPendaftaran ?? 0); ?>%
                ...
                <div class="bg-gradient-to-br from-white to-emerald-50 p-6 rounded-xl shadow-md border border-emerald-100 relative overflow-hidden group hover:shadow-lg transition-all duration-300">
                    <div class="flex justify-between items-start z-10 relative">
                        <div class="flex-1 pr-4"> 
                            ...
                            <div class="flex items-baseline gap-2">
                                <h4 class="text-3xl font-bold text-gray-800"><?php echo e($persentaseKelulusan ?? 0); ?>%</h4>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-2.5 mt-4">
                                <div class="bg-emerald-500 h-2.5 rounded-full" style="width: <?php echo e($persentaseKelulusan ?? 0); ?>%"></div>
                            </div>
                ...
                <div class="bg-gradient-to-br from-white to-orange-50 p-6 rounded-xl shadow-md border border-orange-100 relative overflow-hidden group hover:shadow-lg transition-all duration-300">
                    <div class="flex justify-between items-start z-10 relative">
                        <div>
                            ...
                            <div class="flex items-baseline gap-2">
                                <h4 class="text-3xl font-bold text-gray-800"><?php echo e($asesorAktif ?? 0); ?></h4>
                                <span class="text-sm text-gray-400 font-medium">/ <?php echo e($jumlahAsesor ?? 0); ?> Total</span>
                            </div>
            ...
            <section class="bg-white border border-gray-200 rounded-xl shadow-md p-6 overflow-visible">
                ...
                <div class="flex flex-col lg:flex-row justify-between items-center gap-4 mb-6">
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
                        ...
                        <form action="<?php echo e(route('admin.dashboard')); ?>" method="GET" class="w-full sm:w-96" x-data="{ search: '<?php echo e(request('search', '')); ?>' }">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('filter_jenis_tuk')): ?> <input type="hidden" name="filter_jenis_tuk" value="<?php echo e(request('filter_jenis_tuk')); ?>"> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('filter_status')): ?> <input type="hidden" name="filter_status" value="<?php echo e(request('filter_status')); ?>"> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div x-data="{ perPage: '<?php echo e($perPage ?? 5); ?>', changePerPage() { 
                    ...
                    <div class="relative w-full lg:w-auto flex justify-end" x-data="{ openFilter: false }">
                        ...
                        >
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($filterJenisTuk || ($filterStatus && $filterStatus !== 'Terjadwal')): ?>
                        ...
                        >
                            <div class="p-2">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['Terjadwal', 'Selesai', 'Dibatalkan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('admin.dashboard', array_merge($allParams, ['filter_status' => $status, 'page' => 1]))); ?>"
                                        class="block w-full text-left px-3 py-2 rounded-md text-sm transition-colors <?php echo e($currentStatus == $status ? 'bg-indigo-50 text-indigo-700 font-medium' : 'text-gray-700 hover:bg-gray-50'); ?>">
                                        <?php echo e($status); ?>
                                ...
                                <a href="<?php echo e(route('admin.dashboard', array_merge($allParams, ['filter_jenis_tuk' => ($filterJenisTuk == 1 ? null : 1), 'page' => 1]))); ?>"
                                    class="block w-full text-left px-3 py-2 rounded-md text-sm transition-colors <?php echo e($filterJenisTuk == 1 ? 'bg-blue-50 text-blue-700 font-medium' : 'text-gray-700 hover:bg-gray-50'); ?>">
                                    Sewaktu
                                </a>
                                <a href="<?php echo e(route('admin.dashboard', array_merge($allParams, ['filter_jenis_tuk' => ($filterJenisTuk == 2 ? null : 2), 'page' => 1]))); ?>"
                                    class="block w-full text-left px-3 py-2 rounded-md text-sm transition-colors <?php echo e($filterJenisTuk == 2 ? 'bg-blue-50 text-blue-700 font-medium' : 'text-gray-700 hover:bg-gray-50'); ?>">
                                    Tempat Kerja
                                </a>
                            </div>

                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($filterJenisTuk || $filterStatus): ?>
                                <div class="p-2 border-t border-gray-100 bg-gray-50 rounded-b-xl">
                                    <a href="<?php echo e(route('admin.dashboard', array_merge(request()->except(['filter_jenis_tuk', 'filter_status', 'page']), ['filter_status' => null, 'filter_jenis_tuk' => null, 'page' => 1]))); ?>" 
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-xs text-left border border-gray-200">
                        <thead class="bg-gray-50 text-gray-600 uppercase text-xs">
                            <tr class="divide-x divide-gray-200 border-b border-gray-200">
                                ...
                                <th class="px-4 py-3 font-semibold w-16 text-center">
                                    <?php $isCurrent = $sortColumn == 'id_jadwal'; ?>
                                    <a href="<?php echo e(route('admin.dashboard', array_merge($baseParams, ['sort' => 'id_jadwal', 'direction' => ($isCurrent && $sortDirection == 'asc') ? 'desc' : 'asc']))); ?>" class="flex w-full items-center justify-center gap-1">
                                        <span>ID</span>
                                        <div class="flex flex-col -space-y-1 text-[10px]"><i class="fas fa-caret-up <?php echo e(($isCurrent && $sortDirection == 'asc') ? 'text-gray-900' : 'text-gray-300'); ?>"></i><i class="fas fa-caret-down <?php echo e(($isCurrent && $sortDirection == 'desc') ? 'text-gray-900' : 'text-gray-300'); ?>"></i></div>
                                    </a>
                                </th>
                                ...
                                <th class="px-6 py-3 font-semibold">
                                    <?php $isCurrent = $sortColumn == 'skema_nama'; ?>
                                    <a href="<?php echo e(route('admin.dashboard', array_merge($baseParams, ['sort' => 'skema_nama', 'direction' => ($isCurrent && $sortDirection == 'asc') ? 'desc' : 'asc']))); ?>" class="flex w-full items-center justify-between">
                                ...
                                <th class="px-6 py-3 font-semibold">
                                    <?php $isCurrent = $sortColumn == 'tuk_nama'; ?>
                                    <a href="<?php echo e(route('admin.dashboard', array_merge($baseParams, ['sort' => 'tuk_nama', 'direction' => ($isCurrent && $sortDirection == 'asc') ? 'desc' : 'asc']))); ?>" class="flex w-full items-center justify-between">
                                        <span>TUK</span>
                                        <div class="flex flex-col -space-y-1 text-[10px]"><i class="fas fa-caret-up <?php echo e(($isCurrent && $sortDirection == 'asc') ? 'text-gray-900' : 'text-gray-300'); ?>"></i><i class="fas fa-caret-down <?php echo e(($isCurrent && $sortDirection == 'desc') ? 'text-gray-900' : 'text-gray-300'); ?>"></i></div>
                                    </a>
                                </th>
                                ...
                                <th class="px-6 py-3 font-semibold">
                                    <?php $isCurrent = $sortColumn == 'jenis_tuk'; ?>
                                    <a href="<?php echo e(route('admin.dashboard', array_merge($baseParams, ['sort' => 'jenis_tuk', 'direction' => ($isCurrent && $sortDirection == 'asc') ? 'desc' : 'asc']))); ?>" class="flex w-full items-center justify-between">
                                        <span>Jenis TUK</span>
                                        <div class="flex flex-col -space-y-1 text-[10px]"><i class="fas fa-caret-up <?php echo e(($isCurrent && $sortDirection == 'asc') ? 'text-gray-900' : 'text-gray-300'); ?>"></i><i class="fas fa-caret-down <?php echo e(($isCurrent && $sortDirection == 'desc') ? 'text-gray-900' : 'text-gray-300'); ?>"></i></div>
                                    </a>
                                </th>
                                ...
                                <th class="px-4 py-3 font-semibold text-center">
                                    <?php $isCurrent = $sortColumn == 'sesi'; ?>
                                    <a href="<?php echo e(route('admin.dashboard', array_merge($baseParams, ['sort' => 'sesi', 'direction' => ($isCurrent && $sortDirection == 'asc') ? 'desc' : 'asc']))); ?>" class="flex w-full items-center justify-center gap-1">
                                        <span>Sesi</span>
                                        <div class="flex flex-col -space-y-1 text-[10px]"><i class="fas fa-caret-up <?php echo e(($isCurrent && $sortDirection == 'asc') ? 'text-gray-900' : 'text-gray-300'); ?>"></i><i class="fas fa-caret-down <?php echo e(($isCurrent && $sortDirection == 'desc') ? 'text-gray-900' : 'text-gray-300'); ?>"></i></div>
                                    </a>
                                </th>
                                ...
                                <th class="px-4 py-3 font-semibold text-center">
                                    <?php $isCurrent = $sortColumn == 'kuota_maksimal'; ?>
                                    <a href="<?php echo e(route('admin.dashboard', array_merge($baseParams, ['sort' => 'kuota_maksimal', 'direction' => ($isCurrent && $sortDirection == 'asc') ? 'desc' : 'asc']))); ?>" class="flex w-full items-center justify-center gap-1">
                                        <span>Kuota</span>
                                        <div class="flex flex-col -space-y-1 text-[10px]"><i class="fas fa-caret-up <?php echo e(($isCurrent && $sortDirection == 'asc') ? 'text-gray-900' : 'text-gray-300'); ?>"></i><i class="fas fa-caret-down <?php echo e(($isCurrent && $sortDirection == 'desc') ? 'text-gray-900' : 'text-gray-300'); ?>"></i></div>
                                    </a>
                                </th>
                                ...
                                <th class="px-4 py-3 font-semibold w-32">
                                    <?php $isCurrent = $sortColumn == 'tanggal_pelaksanaan'; ?>
                                    <a href="<?php echo e(route('admin.dashboard', array_merge($baseParams, ['sort' => 'tanggal_pelaksanaan', 'direction' => ($isCurrent && $sortDirection == 'asc') ? 'desc' : 'asc']))); ?>" class="flex w-full items-center justify-between">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $jadwalTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition divide-x divide-gray-200">
                                <td class="px-4 py-4 text-center font-medium text-gray-500"><?php echo e($jadwal->id_jadwal); ?></td>
                                <td class="px-4 py-4">
                                    <div class="h-32 w-32 rounded-md overflow-hidden border border-gray-200 bg-gray-50 mx-auto">
                                        <img src="<?php echo e($jadwal->skema?->gambar_url); ?>" 
                                             alt="<?php echo e($jadwal->skema->nama_skema ?? 'Skema Image'); ?>" 
                                ...
                                <td class="px-4 py-4 font-medium text-gray-700"><?php echo e($jadwal->skema->nomor_skema ?? '-'); ?></td>
                                <td class="px-6 py-4 font-medium text-gray-900"><?php echo e($jadwal->skema->nama_skema ?? '-'); ?></td>
                                <td class="px-6 py-4 text-gray-700"><?php echo e($jadwal->masterTuk->nama_lokasi ?? '-'); ?></td> 
                                <td class="px-6 py-4 text-gray-700"><?php echo e($jadwal->jenisTuk->jenis_tuk ?? '-'); ?></td>
                                <td class="px-4 py-4 text-center font-bold text-gray-700"><?php echo e($jadwal->sesi); ?></td>
                                <td class="px-4 py-4 text-center text-gray-700 whitespace-nowrap"><?php echo e($jadwal->kuota_minimal); ?> / <?php echo e($jadwal->kuota_maksimal); ?></td>
                                <td class="px-4 py-4 font-medium text-blue-700 whitespace-nowrap"><?php echo e(\Carbon\Carbon::parse($jadwal->tanggal_pelaksanaan)->isoFormat('D MMMM Y')); ?></td>
                            </tr>
                ...
                <div class="flex items-center justify-between mt-6 pt-4 border-t border-gray-200">
                    <div class="text-sm text-gray-500 font-bold">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($jadwalTerbaru->total() > 0): ?>
                            Showing <?php echo e($jadwalTerbaru->firstItem()); ?> - <?php echo e($jadwalTerbaru->lastItem()); ?> of <?php echo e($jadwalTerbaru->total()); ?> results
                        <?php else: ?>
                            Showing 0 results
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <div>
                        <?php echo e($jadwalTerbaru->links('components.pagination')); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const dataSkema = <?php echo json_encode($dataSkemaChart, 15, 512) ?>; 
            const dataAsesi = <?php echo json_encode($dataAsesiChart, 15, 512) ?>;
            const dataProgress = <?php echo json_encode($dataProgress, 15, 512) ?>;
            ...
            new Chart(ctxSkema, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: dataSkema, // <-- Gunakan data dinamis
                        borderColor: '#f87171',
            ...
            new Chart(ctxAsesi, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: dataAsesi, // <-- Gunakan data dinamis
            ...
            new Chart(ctxProgress, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: dataProgress, // <-- Gunakan data dinamis
                        backgroundColor: [
