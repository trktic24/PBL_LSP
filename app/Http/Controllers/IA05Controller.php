...
class IA05Controller extends Controller
{
    ...
    public function showSoalForm(Request $request, $id_asesi)
    {
        ...
        $user = new \stdClass();
        $user->id = 1; 
        // GANTI ANGKA INI UNTUK TESTING TAMPILAN:
        // 1 = Admin (Bisa Edit Soal)
        // 2 = Asesi (Bisa Jawab Soal)
        // 3 = Asesor (Cuma Lihat)
        $user->role_id = 1; 
        $user->role = 'admin'; // Sesuaikan: 'admin', 'asesi', 'asesor'
    ...
    public function showKunciForm(Request $request)
    {
        ...
        $user = new \stdClass();
        $user->id = 1; 
        $user->role_id = 1; // Default Admin biar bisa lihat kunci
        $user->role = 'admin';
    ...
    public function showJawabanForm(Request $request, $id_asesi)
    {
        ...
        $user = new \stdClass();
        $user->id = 3; 
        $user->role_id = 1; // Default Asesor biar bisa menilai
        $user->role = 'admin';
