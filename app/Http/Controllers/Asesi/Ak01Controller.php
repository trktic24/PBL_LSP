...
class Ak01Controller extends Controller
{
    ...
    {
        $query = DataSertifikasiAsesi::with(['jadwal.asesor', 'jadwal.jenisTuk', 'jadwal.skema', 'asesi']);
    ...
    /**
     * [MASTER] Menampilkan editor template (Persetujuan Asesmen) per Skema & Jadwal
     */
