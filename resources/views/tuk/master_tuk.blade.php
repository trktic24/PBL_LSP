          ...
          <thead class="bg-gray-50 text-gray-600 uppercase text-xs">
            <tr>
              <th class="px-6 py-3 text-left font-semibold">
                ...
                @endphp
                <a href="{{ route('master_tuk', ['sort' => 'id_tuk', 'direction' => ($isCurrentColumn && $direction == 'asc') ? 'desc' : 'asc', 'search' => request('search')]) }}" class="flex w-full items-center justify-between">
                  <span>ID</span>
              ...
              <th class="px-6 py-3 text-left font-semibold">
                @php
                  ...
                  $direction = request('direction', 'asc');
                @endphp
                <a href="{{ route('master_tuk', ['sort' => 'nama_lokasi', 'direction' => ($isCurrentColumn && $direction == 'asc') ? 'desc' : 'asc', 'search' => request('search')]) }}" class="flex w-full items-center justify-between">
                  <span>Nama TUK (Lokasi)</span>
                  <div class="flex flex-col -space-y-1 text-xs">
                    <i class="fas fa-caret-up {{ ($isCurrentColumn && $direction == 'asc') ? 'text-gray-900' : 'text-gray-300' }}"></i>
                    <i class="fas fa-caret-down {{ ($isCurrentColumn && $direction == 'desc') ? 'text-gray-900' : 'text-gray-300' }}"></i>
                  </div>
              ...
              <th class="px-6 py-3 text-left font-semibold">
                @php
                  ...
                  $direction = request('direction', 'asc');
                @endphp
                <a href="{{ route('master_tuk', ['sort' => 'alamat_tuk', 'direction' => ($isCurrentColumn && $direction == 'asc') ? 'desc' : 'asc', 'search' => request('search')]) }}" class="flex w-full items-center justify-between">
                  <span>Alamat</span>
                  <div class="flex flex-col -space-y-1 text-xs">
                    <i class="fas fa-caret-up {{ ($isCurrentColumn && $direction == 'asc') ? 'text-gray-900' : 'text-gray-300' }}"></i>
                    <i class="fas fa-caret-down {{ ($isCurrentColumn && $direction == 'desc') ? 'text-gray-900' : 'text-gray-300' }}"></i>
              ...
              <th class="px-6 py-3 text-left font-semibold">
                @php
                  ...
                  $direction = request('direction', 'asc');
                @endphp
                <a href="{{ route('master_tuk', ['sort' => 'kontak_tuk', 'direction' => ($isCurrentColumn && $direction == 'asc') ? 'desc' : 'asc', 'search' => request('search')]) }}" class="flex w-full items-center justify-between">
                  <span>Kontak</span>
                  <div class="flex flex-col -space-y-1 text-xs">
                    <i class="fas fa-caret-up {{ ($isCurrentColumn && $direction == 'asc') ? 'text-gray-900' : 'text-gray-300' }}"></i>
                    <i class="fas fa-caret-down {{ ($isCurrentColumn && $direction == 'desc') ? 'text-gray-900' : 'text-gray-300' }}"></i>
