                            ...
                            <th class="px-6 py-3 text-left font-semibold">
                                ...
                                <a href="{{ route('master_tuk', ['sort' => 'id_tuk', 'direction' => $isCurrentColumn && $direction == 'asc' ? 'desc' : 'asc', 'search' => request('search'), 'per_page' => request('per_page')]) }}"
                                    ...
                                    <div class="flex flex-col -space-y-1 text-xs">
                                        <i
                                            class="fas fa-caret-up {{ $isCurrentColumn && $direction == 'asc' ? 'text-gray-900' : 'text-gray-300' }}"></i>
                                        <i
                                            class="fas fa-caret-down {{ $isCurrentColumn && $direction == 'desc' ? 'text-gray-900' : 'text-gray-300' }}"></i>
                                    </div>
                                </a>
                            </th>
                            <th class="px-6 py-3 text-left font-semibold">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse ($tuks as $tuk)
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ Storage::url($tuk->foto_tuk) }}" target="_blank"
