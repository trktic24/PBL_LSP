...
<body class="bg-gray-100 font-sans antialiased text-slate-800">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-xl leading-6 font-bold text-gray-900">Waktu Habis!</h3>
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Waktu pengerjaan telah berakhir. Sistem sedang <strong>mengirimkan jawaban Anda secara otomatis</strong>.
                                </p>
                            </div>
    ...
    <div class="flex min-h-screen flex-col md:flex-row md:h-screen md:overflow-hidden">
        ...
        <x-mobile_header 
            :title="'Asesmen Pilihan Ganda (IA-05)'" 
        ...
        {{-- 3. KONTEN UTAMA --}}
        {{-- pt-24 ditambahkan agar konten tidak tertutup header mobile fixed --}}
                ...
                <div class="flex flex-col lg:flex-row gap-6">
                    <div class="flex-1 lg:w-3/4">
                        ...
                        <div id="question-container" class="hidden">
                            <div class="bg-white rounded-xl shadow-sm p-6 sm:p-8 border border-gray-200 relative overflow-hidden">
                                {{-- Hiasan --}}
                    ...
                    <aside class="lg:w-1/4">
                        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-200 sticky top-6">
                            ...
                            <div class="mt-6 text-xs text-gray-500 space-y-2 bg-gray-50 p-3 rounded-lg">
                                ...
                                <div class="flex items-center">
                                    <div class="w-3 h-3 border border-gray-300 bg-white rounded-sm mr-2"></div> Belum dijawab
                                </div>
                            </div>
                        </div>
                    </aside>
