...
<body class="bg-gray-50 md:bg-white font-sans text-gray-800">
    ...
    <div class="flex min-h-screen flex-col md:flex-row md:h-screen md:overflow-hidden">
        ...
        <x-mobile_header :title="$sertifikasi->jadwal->skema->nama_skema ?? 'Skema Sertifikasi'" :code="$sertifikasi->jadwal->skema->kode_unit ?? ($sertifikasi->jadwal->skema->nomor_skema ?? '-')" :name="$sertifikasi->asesi->nama_lengkap ?? 'Nama Peserta'" :image="$gambarSkema" :sertifikasi="$sertifikasi"
            ...
            <div class="max-w-4xl mx-auto mt-20 md:mt-0 p-6 md:p-0 transition-all pb-24">
                ...
                <div class="hidden md:flex items-center justify-center mb-12">
                    <div class="flex flex-col items-center">
                        <div
                            class="w-10 h-10 bg-yellow-400 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-sm">
                            1</div>
                    </div>
                    <div class="w-24 h-1 bg-yellow-300 mx-4 rounded-full"></div>
                    <div class="flex flex-col items-center">
                        <div
                            class="w-10 h-10 bg-yellow-300 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-sm">
                            2</div>
                    </div>
                    <div class="w-24 h-1 bg-gray-200 mx-4 rounded-full"></div>
                    <div class="flex flex-col items-center">
                        <div
                            class="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center text-gray-500 font-bold text-lg">
                            3</div>
                    </div>
                </div>
                ...
                {{-- HEADING --}}
                <div class="mb-8">
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-2 text-center md:text-left">Bukti
                        Kelengkapan Pemohon</h1>
                ...
                @php
                    $daftarDokumen = [
                        [
                            'jenis' => 'Foto Background Merah',
                            'label' => 'Pas Foto (Background Merah)',
                            'desc' => 'Format: JPG/PNG. Maks 2MB.',
                            'isMulti' => false,
                            'icon' => 'foto',
                        ],
                        [
                            ...
                            'desc' => 'Format: JPG/PDF. NIK harus terlihat jelas.',
                            'isMulti' => false,
                            'icon' => 'ktp',
                        ],
                        [
                            ...
                            'desc' => 'Scan Ijazah Legalisir (PDF/JPG).',
                            'isMulti' => false,
                            'icon' => 'doc',
                        ],
                        [
                            'jenis' => 'Pengalaman Kerja / Curriculum Vitae (CV)',
                            'label' => 'Pengalaman Kerja / Curriculum Vitae (CV)',
                            'desc' => 'Pengalaman Kerja yang berkaitan dengan skema.',
                            'isMulti' => true,
                            'icon' => 'doc',
                        ],
                        [
                            'jenis' => 'Sertifikasi Pelatihan',
                            'label' => 'Sertifikasi Pelatihan / Kompetensi',
                            'desc' => 'Sertifikat relevan (Bisa upload banyak).',
                            'isMulti' => true,
                            'icon' => 'doc',
                        ],
                        [
                            'jenis' => 'Surat Keterangan Kerja',
                            'label' => 'Surat Keterangan Kerja / Portofolio',
                            'desc' => 'Bukti pengalaman/portofolio (Bisa upload banyak).',
                            'isMulti' => true,
                            'icon' => 'doc',
                        ],
                    ];
                ...
                <div class="space-y-5" id="dokumen-container">
                    @foreach ($daftarDokumen as $doc)
                        <div class="upload-section bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden"
                            data-jenis="{{ $doc['jenis'] }}" data-multi="{{ $doc['isMulti'] ? 'true' : 'false' }}">

                            {{-- HEADER CARD --}}
                            <div
                                class="toggle-trigger p-5 flex justify-between items-center cursor-pointer bg-white hover:bg-gray-50 transition-colors">
                                <div class="flex items-center gap-4">
                                    <div
                                        class="w-12 h-12 rounded-xl bg-blue-50 flex items-center justify-center text-blue-600 shrink-0">
                                        @if ($doc['icon'] == 'foto')
                                    ...
                                    <div>
                                        <h3 class="text-base md:text-lg font-bold text-gray-800 leading-tight">
                                            {{ $doc['label'] }}</h3>
                                ...
                                <div class="flex items-center gap-3">
                                    <span
                                        class="status-badge bg-red-100 text-red-600 px-3 py-1 rounded-full text-xs font-bold whitespace-nowrap">Wajib
                                        Diisi</span>
                                    <button type="button" class="text-gray-400 hover:text-blue-600 transition-colors">
                                        <svg class="toggle-icon w-6 h-6 transform transition-transform duration-300"
                            ...
                            <div class="accordion-content bg-gray-50">
                                <div class="p-5 border-t border-gray-100">
                                    ...
                                    <div class="btn-action-wrapper hidden mb-4">
                                        <button type="button"
                                            class="btn-toggle-form flex items-center justify-center w-full md:w-auto px-5 py-2.5 border-2 border-dashed border-blue-300 rounded-xl text-blue-600 font-semibold hover:bg-blue-50 hover:border-blue-500 transition-all gap-2 group">
                                            @if ($doc['isMulti'])
                                            ...
                                            @else
                                                <svg class="w-5 h-5 group-hover:scale-110 transition-transform"
                                                    ...
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                                        d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732">
                                                    </path>
                                                </svg>
                                                Ganti File
                                            @endif
                                    ...
                                    <div class="upload-form-wrapper">
                                        <div
                                            class="bg-white p-4 rounded-xl border border-dashed border-gray-300 hover:border-blue-400 transition-colors relative">

                                            <button type="button"
                                                class="btn-cancel-upload absolute top-2 right-2 text-gray-400 hover:text-red-500 hidden z-10 p-1 rounded-full hover:bg-red-50 transition-colors">
                                            ...
                                            <div class="flex flex-col md:flex-row gap-4 items-start">
                                                {{-- Preview Box --}}
                                                <div
                                                    class="w-full md:w-32 h-32 bg-gray-100 rounded-lg flex items-center justify-center overflow-hidden border border-gray-200 relative shrink-0">
                                                    <img src=""
                                                        class="preview-img w-full h-full object-cover hidden"
                                                        alt="Preview">
                                                    <div class="preview-placeholder text-center p-2">
                                                        <svg class="w-8 h-8 text-gray-300 mx-auto mb-1" fill="none"
                                                ...
                                                <div class="flex-1 w-full space-y-3">
                                                    <div>
                                                        <label
                                                            ...
                                                            File</label>
                                                        <input type="text"
                                                            class="description-input w-full border border-gray-200 rounded-lg text-sm px-4 py-2 focus:ring-2 focus:ring-blue-100 focus:border-blue-500 outline-none transition-all"
                                                            placeholder="Contoh: Dokumen Pendukung">
                                                    </div>
                                                    ...
                                                    <div class="flex gap-3 mt-2">
                                                        <button type="button"
                                                            class="btn-select-file px-4 py-2 bg-blue-50 text-blue-600 text-sm font-bold rounded-lg hover:bg-blue-100 transition-colors">
                                                            Pilih File
                                                        </button>
                                                        <button type="button"
                                                            class="btn-save hidden px-6 py-2 bg-blue-600 text-white text-sm font-bold rounded-lg hover:bg-blue-700 transition-colors shadow-md flex items-center gap-2">
                                                            <span>Simpan</span>
                                                        </button>
                                                    </div>
                                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const nextUrl =
                "{{ route('asesi.show.tandatangan', ['id_sertifikasi' => $sertifikasi->id_data_sertifikasi_asesi]) }}";
            ...
            document.querySelectorAll('.toggle-trigger').forEach(trigger => {
                trigger.addEventListener('click', function() {
                    ...
                    document.querySelectorAll('.upload-section').forEach(sec => {
                        if (sec !== parent) {
                            sec.querySelector('.accordion-content').classList.remove(
                            'open');
                            sec.querySelector('.toggle-icon').style.transform =
                                'rotate(0deg)';
                    ...
                    .then(response => {
                        if (response.success && response.data.length > 0) {
                            ...
                            document.querySelectorAll('.upload-section').forEach(section => {
                                ...
                                const items = data.filter(item => item.keterangan && item.keterangan
                                    .startsWith(jenis));
                                ...
                                if (items.length > 0) {
                                    ...
                                    items.forEach(item => {
                                        ...
                                        const realId = item.id || item.id_bukti_dasar || item
                                            .id_bukti_kelengkapan;
                                        addFileToListUI(listContainer, item.bukti_dasar, item
                                            .keterangan, realId, section);
                                    });
            ...
            document.querySelectorAll('.upload-section').forEach(section => {
                    ...
                    if (file) {
                        ...
                        if (file.type.startsWith('image/')) {
                            ...
                            previewPlaceholder.innerHTML =
                                `<span class="text-xs font-bold text-gray-600 block px-2 truncate">${file.name}</span>`;
                        }
                    }
                });
                ...
                btnSave.addEventListener('click', async () => {
                    ...
                    const ket = descInput.value ? `${jenisDokumen} - ${descInput.value}` :
                        jenisDokumen;
                    ...
                    try {
                        ...
                        if (res.ok && result.success) {
                            ...
                            addFileToListUI(listContainer, file.name, ket, newId, section,
                            true);
            ...
            function updateStatusBadge(section, isFilled) {
                ...
                if (isFilled) {
                    badge.className =
                        'status-badge bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1';
                    badge.innerHTML =
                        `<svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path></svg> Berhasil Upload`;
                } else {
                    badge.className =
                        'status-badge bg-red-100 text-red-600 px-3 py-1 rounded-full text-xs font-bold';
            ...
            function addFileToListUI(container, source, keterangan, id, section, isNewUpload = false) {
                ...
                div.className =
                    'flex items-center justify-between bg-gray-50 p-3 rounded-lg border border-gray-200 animate-[fadeIn_0.3s_ease-out] group hover:border-blue-300 transition-colors';
                            ...
                            fetch(`/api/v1/bukti-kelengkapan/${id}`, {
                                ...
                                .then(data => {
                                    if (data.success) {
                                        ...
                                        Swal.fire('Terhapus!', 'File berhasil dihapus.',
                                            'success');
                                    } else {
                                        Swal.fire('Gagal', data.message || 'Gagal menghapus.',
                                            'error');
                                    }
                                })
                                .catch(err => {
                ...
                btnEdit.addEventListener('click', () => {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            const cleanKet = keterangan.includes(' - ') ? keterangan.split(' - ')[
                                1] : '';
