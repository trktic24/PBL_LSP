    ...
    <div class="p-0">
            <div class="flex flex-col xl:flex-row justify-between items-end mb-8 gap-6">
                <div class="w-full xl:max-w-lg">
                    ...
                    <form action="{{ route('asesor.daftar_hadir', $jadwal->id_jadwal) }}" method="GET" class="w-full max-w-sm" x-data="{ search: '{{ request('search', '') }}' }">
                        <div class="relative">
                    ...
                    <thead class="bg-gray-50 text-gray-600 uppercase text-xs">
                        <tr class="divide-x divide-gray-200 border-b border-gray-200">
                            ...
                            <th class="px-4 py-3 font-semibold w-16 text-center">
                                ...
                                <a href="{{ route('asesor.daftar_hadir', array_merge(['id_jadwal' => $jadwal->id_jadwal], $baseParams, ['sort' => 'id_data_sertifikasi_asesi', 'direction' => ($isCurrent && $sortDirection == 'asc') ? 'desc' : 'asc'])) }}" class="flex w-full items-center justify-center gap-1">
                                    <span>ID</span>
                            ...
                            <th class="px-6 py-3 font-semibold">
                                ...
                                <a href="{{ route('asesor.daftar_hadir', array_merge(['id_jadwal' => $jadwal->id_jadwal], $baseParams, ['sort' => 'nama_lengkap', 'direction' => ($isCurrent && $sortDirection == 'asc') ? 'desc' : 'asc'])) }}" class="flex w-full items-center justify-between">
                            ...
                            <th class="px-6 py-3 font-semibold">
                                ...
                                <a href="{{ route('asesor.daftar_hadir', array_merge(['id_jadwal' => $jadwal->id_jadwal], $baseParams, ['sort' => 'institusi', 'direction' => ($isCurrent && $sortDirection == 'asc') ? 'desc' : 'asc'])) }}" class="flex w-full items-center justify-between">
                            ...
                            <th class="px-6 py-3 font-semibold">
                                ...
                                <a href="{{ route('asesor.daftar_hadir', array_merge(['id_jadwal' => $jadwal->id_jadwal], $baseParams, ['sort' => 'alamat_rumah', 'direction' => ($isCurrent && $sortDirection == 'asc') ? 'desc' : 'asc'])) }}" class="flex w-full items-center justify-between">
                                    <span>Alamat</span>
                                    <div class="flex flex-col -space-y-1 text-[10px]"><i class="fas fa-caret-up {{ ($isCurrent && $sortDirection == 'asc') ? 'text-gray-900' : 'text-gray-300' }}"></i><i class="fas fa-caret-down {{ ($isCurrent && $sortDirection == 'desc') ? 'text-gray-900' : 'text-gray-300' }}"></i></div>
                                </a>
                            </th>
                            ...
                            <th class="px-6 py-3 font-semibold">
                                ...
                                <a href="{{ route('asesor.daftar_hadir', array_merge(['id_jadwal' => $jadwal->id_jadwal], $baseParams, ['sort' => 'pekerjaan', 'direction' => ($isCurrent && $sortDirection == 'asc') ? 'desc' : 'asc'])) }}" class="flex w-full items-center justify-between">
                                    <span>Pekerjaan</span>
                                    <div class="flex flex-col -space-y-1 text-[10px]"><i class="fas fa-caret-up {{ ($isCurrent && $sortDirection == 'asc') ? 'text-gray-900' : 'text-gray-300' }}"></i><i class="fas fa-caret-down {{ ($isCurrent && $sortDirection == 'desc') ? 'text-gray-900' : 'text-gray-300' }}"></i></div>
                                </a>
                            </th>
                            ...
                            <th class="px-6 py-3 font-semibold">
                                ...
                                <a href="{{ route('asesor.daftar_hadir', array_merge(['id_jadwal' => $jadwal->id_jadwal], $baseParams, ['sort' => 'nomor_hp', 'direction' => ($isCurrent && $sortDirection == 'asc') ? 'desc' : 'asc'])) }}" class="flex w-full items-center justify-between">
                                    <span>No. HP</span>
                                    <div class="flex flex-col -space-y-1 text-[10px]"><i class="fas fa-caret-up {{ ($isCurrent && $sortDirection == 'asc') ? 'text-gray-900' : 'text-gray-300' }}"></i><i class="fas fa-caret-down {{ ($isCurrent && $sortDirection == 'desc') ? 'text-gray-900' : 'text-gray-300' }}"></i></div>
                                </a>
                            </th>                            
