                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-yellow-100">
                                ...
                                <td class="p-4 text-center">
                                    ...
                                    @if($hasAk07Data)
                                    {{-- Sudah ada data: Lihat Penyesuaian (Abu-abu) --}}
                                    <a href="{{ route('asesor.ak07', $item->id_data_sertifikasi_asesi) }}"
                                        class="bg-gray-500 text-white px-2 py-1 rounded-md text-xs font-medium hover:bg-gray-600 whitespace-nowrap">
                                        Lihat Penyesuaian
                                    </a>
                                    @else
                                    {{-- Belum ada data: Lakukan Penyesuaian (Kuning) --}}
                                    <a href="{{ route('asesor.ak07', $item->id_data_sertifikasi_asesi) }}"
