                    ...
                    <div>
                        <div class="flex justify-between items-start">
                            ...
                            <div class="flex space-x-2 ml-4">
                                {{-- Tombol Dinamis --}}
                                <a href="{{ route('APL_01_1', $dataSertifikasi->id_data_sertifikasi_asesi) }}" class="bg-blue-100 text-blue-600 hover:bg-blue-200 text-xs font-bold py-1 px-3 rounded-md">Lihat File</a>
                            <a href="#" 
                ...
                <div class="relative pl-20 pb-8 group">
                    ...
                    <div>
                        <div class="flex justify-between items-start">
                            ...
                            <div class="flex space-x-2 ml-4">
                                {{-- Tombol Dinamis --}}
                                <a href="{{ route('mapa01.index', $dataSertifikasi->id_data_sertifikasi_asesi) }}" class="bg-blue-100 text-blue-600 hover:bg-blue-200 text-xs font-bold py-1 px-3 rounded-md">Lihat File</a>
                            <a href="#" 
                            class="bg-red-600 text-white text-xs font-bold py-1 px-3 rounded-md hover:bg-red-700 transition flex items-center gap-1">
