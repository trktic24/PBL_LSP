...
<head>
  ...
  <title>Edit Asesi (Step 2) | LSP Polines</title>
      ...
      <div class="w-full max-w-5xl bg-white border border-gray-200 rounded-xl shadow-lg p-10">
        ...
        <form action="#" method="POST" class="space-y-8">
          ...
          <div class="flex justify-between items-center pt-6 border-t mt-10">
            <a href="{{ route('edit_asesi1') }}" class="px-6 py-2.5 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-lg text-sm shadow-sm transition">
              Sebelumnya
            </a>
            <a href="{{ route('edit_asesi3') }}" class="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg text-sm shadow-md transition">
              Selanjutnya
            </a>
          </div>
        </form>
