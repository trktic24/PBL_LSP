...
<head>
  ...
  <title>Edit Asesi (Step 3) | LSP Polines</title>
    ...
    <main class="flex-1 flex justify-center items-start pt-10 pb-12">
      <div class="w-full max-w-4xl bg-white border border-gray-200 rounded-xl shadow-lg p-10">
        ...
        <div class="flex items-center justify-center mb-10">
          <h1 class="text-3xl font-bold text-gray-900 text-center">EDIT ASESI</h1>
        </div>
        ...
        <form action="#" method="POST" class="space-y-6">
          ...
          <div class="border border-gray-300 rounded-lg bg-white shadow-sm" x-data="{ open: true }">
            ...
            <div x-show="open" class="p-6 border-t border-gray-200 bg-gray-50 space-y-4">
              ...
              <textarea class="w-full p-3 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
                rows="2" placeholder="Tambahkan Keterangan..."></textarea>
              <div class="flex justify-end space-x-3">
                <button type="button"
                  class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-lg text-sm">Cancel</button>
                <button type="button"
                  class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg text-sm">Upload</button>
              </div>
            </div>
          </div>
          ...
          <div class="border border-gray-300 rounded-lg bg-white shadow-sm" x-data="{ open: false }">
            ...
            <div x-show="open" class="p-6 border-t border-gray-200 bg-gray-50 space-y-4">
              ...
              <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                <i class="fas fa-cloud-upload-alt text-3xl text-gray-400 mb-2"></i>
                <p class="text-sm text-gray-600">Drag & drop file di sini, atau klik untuk upload</p>
                <input type="file" class="hidden" id="file_sertifikasi">
                <label for="file_sertifikasi" class="cursor-pointer text-blue-600 hover:underline text-sm font-medium">Pilih
                  file</label>
              </div>
              <textarea class="w-full p-3 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
                rows="2" placeholder="Tambahkan Keterangan..."></textarea>
          ...
          <div class="border border-gray-300 rounded-lg bg-white shadow-sm" x-data="{ open: false }">
            ...
            <div x-show="open" class="p-6 border-t border-gray-200 bg-gray-50 space-y-4">
              ...
              <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                <i class="fas fa-cloud-upload-alt text-3xl text-gray-400 mb-2"></i>
                <p class="text-sm text-gray-600">Drag & drop file di sini, atau klik untuk upload</p>
                <input type="file" class="hidden" id="file_skk">
                <label for="file_skk" class="cursor-pointer text-blue-600 hover:underline text-sm font-medium">Pilih file</label>
              </div>
              <textarea class="w-full p-3 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
                rows="2" placeholder="Tambahkan Keterangan..."></textarea>
              <div class="flex justify-end space-x-3">
          ...
          <div class="flex justify-between items-center pt-6 border-t mt-10">
            <a href="{{ route('edit_asesi2') }}"
              class="px-6 py-2.5 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-lg text-sm shadow-sm transition">
              Sebelumnya
            </a>
            <a href="{{ route('edit_asesi4') }}"
              class="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg text-sm shadow-md transition">
              Selanjutnya
            </a>
          </div>
        </form>
