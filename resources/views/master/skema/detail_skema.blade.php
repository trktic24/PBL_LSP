    ...
    <main class="content-area p-6">
        ...
        <div class="mb-6">
            <p class="text-sm text-gray-500 mb-1">
                <a href="{{ route('master_skema') }}" class="hover:text-blue-600">Master Skema</a> / Detail
            </p>
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                @if($skema->kelompokPekerjaan->isNotEmpty())
                    ...
                    <div class="flex space-x-2">
                        <a href="{{ route('skema.detail.edit_kelompok', $kelompokId) }}" 
                        ...
                        <form action="{{ route('skema.detail.destroy_kelompok', $kelompokId) }}" method="POST" 
                            ...
                            @foreach($units as $index => $unit)
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-4 py-3 text-center border border-gray-200">
                                        <form action="{{ route('skema.detail.destroy_unit', ['id_unit' => $unit->id_unit_kompetensi, 'no' => $currentNo]) }}" 
                                              method="POST" 
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center border border-gray-200 bg-gray-50/50">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <a href="{{ route('skema.detail.add_kelompok', $skema->id_skema) }}" 
