        ...
        <form action="{{ route('update_schedule', $jadwal->id_jadwal) }}" method="POST" class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div class="relative w-full">
                <select id="id_skema" name="id_skema" required class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none bg-white appearance-none pr-10">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <input type="number" id="kuota_maksimal" name="kuota_maksimal" value="{{ old('kuota_maksimal', $jadwal->kuota_maksimal) }}" required min="1" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" placeholder="Cth: 20">
            </div>
            <div>
              <label for="kuota_minimal" class="block text-sm font-medium text-gray-700 mb-2">Kuota Minimal</label>
              <input type="number" id="kuota_minimal" name="kuota_minimal" value="{{ old('kuota_minimal', $jadwal->kuota_minimal) }}" min="1" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" placeholder="Cth: 15">
            </div>
            <div>
              <label for="sesi" class="block text-sm font-medium text-gray-700 mb-2">Sesi <span class="text-red-500">*</span></label>
              <input type="number" id="sesi" name="sesi" value="{{ old('sesi', $jadwal->sesi) }}" required min="1" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" placeholder="Cth: 1">
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="datetime-local" id="tanggal_mulai" name="tanggal_mulai" 
                     ...
                     required class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none">
            </div>
            <div>
