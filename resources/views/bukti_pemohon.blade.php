            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="space-y-4">
                        ...
                        <div class="flex items-center space-x-5">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex space-x-3">
                                    ...
                                    <label for="file-upload-0" class="cursor-pointer px-5 py-2 bg-blue-500 text-white text-sm font-medium rounded-md hover:bg-blue-600">
                                        Upload
                                    </label>
                        ...
                        <div class="flex items-center space-x-5">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex space-x-3">
                                    ...
                                    <label for="file-upload-1" class="cursor-pointer px-5 py-2 bg-blue-500 text-white text-sm font-medium rounded-md hover:bg-blue-600">
                                        Upload
                                    </label>
                                    <button type="button" class="px-5 py-2 bg-gray-200 text-gray-800 text-sm font-medium rounded-md hover:bg-gray-300">
                                        Cancel
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-5">
                        <div class="flex justify-between items-center mb-4">
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900">Pengalaman Kerja / Curriculum Vitae (CV)</h3>
                        ...
                        <div class="flex items-center space-x-5">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex space-x-3">
                                    ...
                                    <label for="file-upload-2" class="cursor-pointer px-5 py-2 bg-blue-500 text-white text-sm font-medium rounded-md hover:bg-blue-600">
                                        Upload
                                    </label>
                                    <button type="button" class="px-5 py-2 bg-gray-200 text-gray-800 text-sm font-medium rounded-md hover:bg-gray-300">
                                        Cancel
                        ...
                        <div class="flex items-center space-x-5">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex space-x-3">
                                    ...
                                    <label for="file-upload-3" class="cursor-pointer px-5 py-2 bg-blue-500 text-white text-sm font-medium rounded-md hover:bg-blue-600">
                                        Upload
                                    </label>
                                    <button type="button" class="px-5 py-2 bg-gray-200 text-gray-800 text-sm font-medium rounded-md hover:bg-gray-300">
                                        Cancel
                        ...
                        <div class="flex items-center space-x-5">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex space-x-3">
                                    ...
                                    <label for="file-upload-4" class="cursor-pointer px-5 py-2 bg-blue-500 text-white text-sm font-medium rounded-md hover:bg-blue-600">
                                        Upload
                                    </label>
                                    <button type="button" class="px-5 py-2 bg-gray-200 text-gray-800 text-sm font-medium rounded-md hover:bg-gray-300">
                                        Cancel
                ...
                <div class="flex justify-between items-center mt-10">
                    <a href="/data_sertifikasi" class="px-8 py-3 bg-gray-200 text-gray-700 font-semibold rounded-full hover:bg-gray-300">
                        Sebelumnya
                    </a>
                    <a href="/tanda_tangan_pemohon" class="px-8 py-3 bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 shadow-md">
                        Selanjutnya
                    </a>
                </div>
