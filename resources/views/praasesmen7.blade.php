    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-12 bg-white overflow-y-auto">
            <div class="max-w-4xl mx-auto">
                ...
                <h2 class="text-2xl font-semibold text-gray-800 mb-1">Membuat Dokumen Kode Program</h2>
                <p class="text-sm text-gray-500 mb-10">Unit Kompetensi 7 dari 8</p>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4">
                                    <div class="flex">
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-gray-900">Melakukan identifikasi kode program</p>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4">
                                    <div class="flex">
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-gray-900">Membuat dokumentasi modul program</g>
                                            <ul class="list-decimal list-outside pl-5 mt-2 text-xs text-gray-600 space-y-1">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4">
                                    <div class="flex">
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-gray-900">Membuat dokumentasi fungsi, prosedur atau method program</p>
                                            <ul class="list-decimal list-outside pl-5 mt-2 text-xs text-gray-600 space-y-1">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4">
                                    <div class="flex">
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-gray-900">Men-generate dokumentasi</p>
                                            <ul class="list-decimal list-outside pl-5 mt-2 text-xs text-gray-600 space-y-1">
                ...
                <div class="flex justify-between items-center mt-12">
                    <a href="/praasesmen6" class="px-8 py-3 bg-gray-200 text-gray-700 font-semibold rounded-full hover:bg-gray-300 transition-colors">
                        Sebelumnya
                    </a>
                    <a href="/praasesmen8" class="px-8 py-3 bg-blue-500 text-white font-semibold rounded-full hover:bg-blue-600 shadow-md transition-colors">
                        Selanjutnya
                    </a>
                </div>
