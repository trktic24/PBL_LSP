    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-12 bg-white overflow-y-auto">
            <div class="max-w-4xl mx-auto">
                ...
                <h2 class="text-2xl font-semibold text-gray-800 mb-1">Menulis Kode Dengan Prinsip Sesuai Guidelines dan Best Practices</h2>
                <p class="text-sm text-gray-500 mb-10">Unit Kompetensi 4 dari 8</p>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4">
                                    <div class="flex">
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-gray-900">Menerapkan codingguidelines dan best practices dalam penulisan program (kode sumber)</p>
                                            <ul class="list-decimal list-outside pl-5 mt-2 text-xs text-gray-600 space-y-1">
                                                <li>Kode sumber dituliskan mengikuti coding-guidelines dan best practices.</li>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4">
                                    <div class="flex">
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-gray-900">Menggunakan ukuran performansi dalam menuliskan kode sumber</p>
                                            <ul class="list-decimal list-outside pl-5 mt-2 text-xs text-gray-600 space-y-1">
