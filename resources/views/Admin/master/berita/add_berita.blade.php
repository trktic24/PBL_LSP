...
<head>
    ...
    <title>Tambah Berita | LSP Polines</title>
                ...
                <form action="{{ route('add_berita.store') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <textarea name="isi" rows="10" 
                                  ...
                                  placeholder="Tuliskan isi konten berita di sini..." required>{{ old('isi') }}</textarea>
                    </div>
                    ...
                    <div class="pt-6 border-t mt-6">
                        <button type="submit" class="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md transition flex justify-center items-center text-lg">
                            <i class="fas fa-paper-plane mr-2"></i> Publish Berita
                        </button>
                    </div>
                </form>
            </div>
