...
<head>
    ...
    <title>Add Kategori | LSP Polines</title> <script src="https://cdn.tailwindcss.com"></script>
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-1 flex justify-center items-start pt-10 pb-12">
            <div class="w-full max-w-4xl bg-white border border-gray-200 rounded-xl shadow-lg p-10">
                ...
                <form action="{{ route('admin.add_category.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-gray-500">
                            Slug (link) akan dibuat secara otomatis.
                        </p>
                    </div>
