  ...
  <div class="min-h-screen flex flex-col">
    ...
    <main class="flex-1 flex justify-center items-start pt-10 pb-12 px-4">
      <div class="w-full max-w-4xl bg-white border border-gray-200 rounded-xl shadow-lg p-10">
        ...
        <form action="{{ route('asesor.update.step3', $asesor->id_asesor) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
          @csrf
          @method('PATCH') 
          ...
          <div class="flex items-center justify-between pt-6">
            <a href="{{ route('edit_asesor2', $asesor->id_asesor) }}"
