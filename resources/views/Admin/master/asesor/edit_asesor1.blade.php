    ...
    <main class="flex-1 flex flex-col items-center pt-10 pb-12 px-4">
      <div class="w-full max-w-4xl bg-white border border-gray-200 rounded-xl shadow-lg p-10">
        ...
        <form action="{{ route('admin.asesor.update.step1', $asesor->id_asesor) }}" method="POST" class="space-y-6 max-w-lg mx-auto" x-data="{ showPassword: false }">
          ...
          <div>
            <label for="nama" class="block text-sm font-medium text-gray-700 mb-2">Username <span class="text-red-500">*</span></label>
          ...
          <div class="flex items-center">
            ...
            <label for="show_password" class="ml-2 block text-sm text-gray-900 cursor-pointer">Tampilkan Password</label>
          </div>
