...
<head>
  ...
  <style>
    ...
    /* Styling Dropdown agar ada panah */
    select {
  ...
  <div class="min-h-screen flex flex-col">
    ...
    <main class="flex-1 flex flex-col items-center pt-10 pb-12 px-4">
      <div class="w-full max-w-4xl bg-white border border-gray-200 rounded-xl shadow-lg p-10">
        ...
        <!-- Header: Tombol Back mengarah ke Master Asesor (Bukan step sebelumnya) -->
        ...
        <form action="{{ route('admin.add_asesor2.post') }}" method="POST" class="space-y-6">
          ...
          {{-- Searchable Dropdown Skema --}}
          @php 
            $currentSkemas = array_map('intval', old('skema_ids', $selectedSkemas ?? [])); 
          @endphp
          ...
          <div class="flex items-center justify-between pt-6">
            <!-- Tombol "Sebelumnya" mengarah ke Step 1 -->
