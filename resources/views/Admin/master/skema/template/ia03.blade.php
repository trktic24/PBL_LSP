    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-1 pt-12 pb-24 px-6">
            <div class="max-w-4xl mx-auto" x-data="templateHandler()">
                ...
                <!-- Header -->
                <div class="mb-12">
                    <a href="{{ route('admin.skema.template.list', [$skema->id_skema, 'FR.IA.03']) }}" class="inline-flex items-center text-indigo-600 hover:text-indigo-800 font-bold mb-6 group">
