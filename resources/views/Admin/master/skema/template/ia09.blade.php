    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-1 pt-12 pb-24 px-6">
            <div class="max-w-4xl mx-auto" x-data="templateHandler()">
                ...
                <!-- Header -->
                <div class="mb-12">
                    <a href="{{ route('admin.skema.detail', $skema->id_skema) }}" class="inline-flex items-center text-emerald-600 hover:text-emerald-800 font-bold mb-6 group tracking-widest text-[10px] uppercase">
                ...
                <form id="templateForm" action="{{ route('admin.skema.template.ia09.store', $skema->id_skema) }}" method="POST">
                    @csrf
                    <div class="space-y-6">
