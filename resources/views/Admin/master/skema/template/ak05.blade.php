    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-1 pt-12 pb-24 px-6">
            <div class="max-w-5xl mx-auto">
                ...
                <!-- Header -->
                <div class="mb-12">
                    <a href="{{ route('admin.skema.template.list', [$skema->id_skema, 'FR.AK.05']) }}" class="inline-flex items-center text-indigo-600 hover:text-indigo-800 font-bold mb-6 group tracking-[0.2em] text-[10px]">
                ...
                <form id="templateForm" action="{{ route('admin.skema.template.ak05.store', [$skema->id_skema, $id_jadwal]) }}" method="POST">
                    @csrf
