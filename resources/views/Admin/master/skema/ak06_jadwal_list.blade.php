...
@section('title', 'Daftar Jadwal AK.06')
                ...
                <tr class="hover:bg-emerald-50/40 transition group">
                    ...
                    <td class="px-6 py-6">
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-600 to-emerald-400 flex items-center justify-center text-white font-bold text-sm shadow-sm">
                    ...
                    <td class="px-6 py-6 text-center">
                        <a href="{{ route('asesor.ak06', $jadwal->id_jadwal) }}" class="inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl transition shadow-sm hover:shadow-emerald-200 transform hover:scale-105 active:scale-95 whitespace-nowrap">
