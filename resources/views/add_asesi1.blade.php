...
<head>
  ...
  <title>Add Asesi (Step 1) | LSP Polines</title>
      ...
      <div class="w-full max-w-5xl bg-white border border-gray-200 rounded-xl shadow-lg p-10">
        ...
        <form action="#" method="POST" class="space-y-8">
          ...
          <div class="flex justify-end items-center pt-6 border-t mt-10">
            <a href="{{ route('add_asesi2') }}" class="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg text-sm shadow-md transition">
              Selanjutnya
            </a>
          </div>
        </form>
