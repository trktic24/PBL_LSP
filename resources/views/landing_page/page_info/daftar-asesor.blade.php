                ...
                <table class="w-full">
                    ...
                    <thead class="bg-yellow-50 border-b-2 border-gray-900">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-sm font-bold text-gray-900 text-center">Bidang Pekerjaan</th>
                    ...
                    <tbody id="tableBody">
                        @forelse($asesors as $asesor)
                            <tr class="table-row border-b border-gray-200 bg-yellow-50 hover:bg-yellow-100 transition">
                                <td class="px-6 py-4 text-sm text-gray-900 text-left">{{ $asesor ->nama_lengkap }}</td>
                                <td class="px-6 py-4 text-sm text-gray-900 text-center">{{ $asesor ->nomor_regis }}</td>
                                <td class="px-6 py-4 text-sm text-gray-900 text-center">{{ $asesor ->pekerjaan }}</td>
