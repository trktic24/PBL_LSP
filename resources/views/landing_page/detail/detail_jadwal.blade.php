...
<div class="container mx-auto px-4 py-8 pt-24 max-w-6xl">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="mb-6">
            <h1 class="text-3xl font-bold mb-4">{{ $jadwal->nama_skema }}</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-600 leading-relaxed">{{ $jadwal->persyaratan }}</p>
                </div>
            </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white border border-gray-300 rounded-lg p-12" style="box-shadow: 6px 6px 10px rgba(0, 0, 0, 0.12);">
                    <div class="flex justify-between items-center mb-5">
                        ...
                        <span class="font-bold text-lg">RP. {{ number_format($jadwal->harga, 0, ',', '.') }}</span>
                    </div>
