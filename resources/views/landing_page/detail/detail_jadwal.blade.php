        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="mb-6">
                ...
                <div class="flex flex-wrap gap-6 text-gray-900 text-sm">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span>{{ $jadwal->tanggal_mulai ? $jadwal->tanggal_mulai->format('H:i') : 'N/A' }} -
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2">
                    ...
                    <div class="mb-12">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            {{ $jadwal->skema->deskripsi ?? 'Deskripsi skema belum tersedia.' }}</p>
                    </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white border border-gray-300 rounded-lg p-12"
                        style="box-shadow: 6px 6px 10px rgba(0, 0, 0, 0.12);">
                        ...
                        <button id="btn-daftar-sekarang" data-jadwal-id="{{ $jadwal->id_jadwal }}"
                            ...
                            Daftar Sekarang {{ $jadwal->id_jadwal }}
                        </button>
