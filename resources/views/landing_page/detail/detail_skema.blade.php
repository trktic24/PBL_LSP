...
@section('content')
    ...
    {{-- Jadwal Sertifikasi Terkait (Pengecekan isset wajib karena bisa null) --}}
    <section class="container mx-auto px-8 py-10">
        <h2 class="text-3xl font-bold mb-6">Jadwal Pelaksanaan</h2>

        @if(isset($jadwalTerkait) && $jadwalTerkait)
            <div class="bg-white rounded-2xl shadow-[6px_6px_20px_rgba(0,0,0,0.25)] p-8 border-2 border-blue-500 max-w-3xl mx-auto">
                ...
                <div class="space-y-4 mb-8">
                    <div class="flex items-center gap-3 text-base">
                        ...
                        {{-- Format tanggal menggunakan properti dari DateTime object --}}
