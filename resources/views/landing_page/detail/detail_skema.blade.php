...
@section('content')
    ...
    {{-- Jadwal Sertifikasi Terkait (OTOMATIS dari Controller) --}}
    <section class="container mx-auto px-8 py-10">
        <h2 class="text-3xl font-bold mb-6">Jadwal Pelaksanaan</h2>

        @if(isset($jadwalTerkait))
            <div class="bg-white rounded-2xl shadow-[6px_6px_20px_rgba(0,0,0,0.25)] p-8 border-2 border-blue-500 max-w-3xl mx-auto">
                <h3 class="font-bold text-xl text-center mb-6">{{ $jadwalTerkait->nama_skema }}</h3>
                ...
                <div class="space-y-4 mb-8">
                    <div class="flex items-center gap-3 text-base">
                        ...
                        <span>{{ $jadwalTerkait->tanggal->format('d F Y') }}</span>
                    </div>
                    ...
                    <div class="flex items-center gap-3 text-base">
                        ...
                        <span>Waktu: {{ $jadwalTerkait->waktu_mulai }} - {{ $jadwalTerkait->waktu_selesai }}</span>
                    </div>

                    <div class="flex items-center gap-3 text-base">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" 
                                d="M12 8c0-1.1-.9-2-2-2H8a2 2 0 100 4h2c1.1 0 2-.9 2-2z" 
                                clip-rule="evenodd"/>
                        </svg>
                        <span>Harga: Rp{{ number_format($jadwalTerkait->harga, 0, ',', '.') }}</span>
                    </div>
                </div>

                <div class="flex justify-center">
                    <a href="{{ route('detail_jadwal', $jadwalTerkait->id) }}"
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-2xl p-6 border-2 border-blue-500 shadow-xl">
                ...
                <ul class="list-disc list-inside space-y-1 text-gray-700">
                    ...
                    <li>Menerapkan prosedur keamanan dasar jaringan</li>
                </ul>
            </div>

            {{-- Unit 2 --}}
            <div class="bg-white rounded-2xl p-6 border-2 border-blue-500 shadow-xl">
                <h3 class="text-lg font-bold text-blue-600 mb-3">Kode Unit : 987654321</h3>
                <ul class="list-disc list-inside space-y-1 text-gray-700">
                    <li>Menganalisis potensi ancaman keamanan sistem</li>
                    <li>Mengimplementasikan pengamanan berbasis firewall</li>
                </ul>
            </div>
        </div>
    </section>
