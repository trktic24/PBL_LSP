                    ...
                    <fieldset x-show="currentStep === 1"  style="display: none;">
                        ...
                        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
                            ...
                            <a :href="'{{ route('google.login') }}?role=' + role"
                                class="w-full sm:w-1/2 flex items-center justify-center gap-3 py-3 px-6 bg-white border border-gray-300 rounded-full text-sm font-semibold text-gray-700 hover:bg-gray-100 transition-colors">
                        ...
                        <div class="space-y-8">
                            <div>
                                ...
                                <div class="mt-6 space-y-4">
                                    {{-- NAMA FILE DI FORM -> NAMA KOLOM DI DB --}}
                                    <x-file-input id="ktp_file" name="ktp_file" label="KTP" required/>
                                    <x-file-input id="foto_file" name="foto_file" label="Pas Foto" required />
                                    ...
                                    <x-file-input id="cv_file" name="cv_file" label="Curriculum Vitae" required />
