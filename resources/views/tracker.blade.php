                    ...
                    <ol class="relative">
                        ...
                        <li class="relative flex items-start pb-10">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="space-y-4">
                                    {{-- Sub-item: Pilihan Ganda --}}
                                    <div class="flex justify-between items-start space-x-4">
                                        <div>
                                            @if ($level >= $LVL_SETUJU)
                                                <a href="{{ route('asesmen.ia05.view', ['id_sertifikasi' => $sertifikasi->id_data_sertifikasi_asesi]) }}" class="font-medium text-gray-800">Pertannyaan Pilihan Ganda
                                                </a>
                                            @else
                                                <h4 class="{{ $linkClassDisabled }} font-medium">Pertannyaan Pilihan Ganda
                                                </h4>
                                            @endif
                                            @if ($level >= $LVL_ASESMEN)
                                    ...
                                    <div class="flex justify-between items-start space-x-4">
                                        <div>
                                            @if ($level >= $LVL_SETUJU)
                                                <a href="{{ route('asesmen.ia06.view', ['id_sertifikasi' => $sertifikasi->id_data_sertifikasi_asesi]) }}" class="font-medium text-gray-800">Pertannyaan Esai
                                                </a>
                                            @else
                                    ...
                                    <div class="flex justify-between items-start space-x-4">
                                        <div>
                                            @if ($level >= $LVL_SETUJU)
                                                <a href="#" class="font-medium text-gray-800">Pertannyaan Lisan
                                                </a>
                                            @else
