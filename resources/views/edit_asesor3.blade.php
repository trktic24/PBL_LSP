  ...
  <div class="min-h-screen flex flex-col">
    ...
    <main class="flex-1 flex justify-center items-start pt-10 pb-12 px-4">
      ...
      <div class="w-full max-w-4xl bg-white border border-gray-200 rounded-xl shadow-lg p-10">
        ...
        <form action="{{ route('asesor.update', $asesor->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
          @csrf
          @method('PATCH') <h3 class="text-xl font-semibold text-gray-800 border-b pb-2 mb-2">Kelengkapan Dokumen</h3>
          ...
          <div x-data="{ fileName: '' }">
            ...
            <div class="text-sm text-gray-600 mb-2">
                File saat ini: <a href="{{ Storage::url($asesor->file_ktp) }}" target="_blank" class="text-blue-600 hover:underline">{{ basename($asesor->file_ktp) }}</a>
            </div>
            @endif
          ...
          <div x-data="{ fileName: '' }">
            ...
            @if($asesor->file_foto)
            <div class="text-sm text-gray-600 mb-2">
                File saat ini: <a href="{{ Storage::url($asesor->file_foto) }}" target="_blank" class="text-blue-600 hover:underline">{{ basename($asesor->file_foto) }}</a>
            </div>
            @endif
            <div class="flex items-center justify-between w-full p-2.5 border border-gray-300 rounded-lg">
              <span x-text="fileName || 'Pilih file baru (opsional)'" class="text-gray-500 text-sm pl-2 truncate w-full max-w-xs sm:max-w-md"></span>
          ...
          <div x-data="{ fileName: '' }">
            <label for="file_npwp" class="block text-sm font-medium text-gray-700 mb-2">NPWP <span class="text-red-500">*</span></label>
             @if($asesor->file_npwp)
            <div class="text-sm text-gray-600 mb-2">
                File saat ini: <a href="{{ Storage::url($asesor->file_npwp) }}" target="_blank" class="text-blue-600 hover:underline">{{ basename($asesor->file_npwp) }}</a>
            </div>
            @endif
            <div class="flex items-center justify-between w-full p-2.5 border border-gray-300 rounded-lg">
              <span x-text="fileName || 'Pilih file baru (opsional)'" class="text-gray-500 text-sm pl-2 truncate w-full max-w-xs sm:max-w-md"></span>
              ...
              <input type="file" id="file_npwp" name="file_npwp" class="hidden"
                     @change="fileName = $event.target.files[0] ? $event.target.files[0].name : ''">
            </div>
          </div>
          ...
          <div x-data="{ fileName: '' }">
            ...
            @if($asesor->file_rekening)
            <div class="text-sm text-gray-600 mb-2">
                File saat ini: <a href="{{ Storage::url($asesor->file_rekening) }}" target="_blank" class="text-blue-600 hover:underline">{{ basename($asesor->file_rekening) }}</a>
            </div>
            @endif
            <div class="flex items-center justify-between w-full p-2.5 border border-gray-300 rounded-lg">
              <span x-text="fileName || 'Pilih file baru (opsional)'" class="text-gray-500 text-sm pl-2 truncate w-full max-w-xs sm:max-w-md"></span>
              ...
              <input type="file" id="file_rekening" name="file_rekening" class="hidden"
                     @change="fileName = $event.target.files[0] ? $event.target.files[0].name : ''">
            </div>
          </div>
          ...
          <div x-data="{ fileName: '' }">
            ...
            @if($asesor->file_cv)
            <div class="text-sm text-gray-600 mb-2">
                File saat ini: <a href="{{ Storage::url($asesor->file_cv) }}" target="_blank" class="text-blue-600 hover:underline">{{ basename($asesor->file_cv) }}</a>
            </div>
            @endif
            <div class="flex items-center justify-between w-full p-2.5 border border-gray-300 rounded-lg">
              <span x-text="fileName || 'Pilih file baru (opsional)'" class="text-gray-500 text-sm pl-2 truncate w-full max-w-xs sm:max-w-md"></span>
              ...
              <input type="file" id="file_cv" name="file_cv" class="hidden"
                     @change="fileName = $event.target.files[0] ? $event.target.files[0].name : ''">
            </div>
          </div>
          ...
          <div x-data="{ fileName: '' }">
            ...
            @if($asesor->file_ijazah)
            <div class="text-sm text-gray-600 mb-2">
                File saat ini: <a href="{{ Storage::url($asesor->file_ijazah) }}" target="_blank" class="text-blue-600 hover:underline">{{ basename($asesor->file_ijazah) }}</a>
            </div>
            @endif
            <div class="flex items-center justify-between w-full p-2.5 border border-gray-300 rounded-lg">
              <span x-text="fileName || 'Pilih file baru (opsional)'" class="text-gray-500 text-sm pl-2 truncate w-full max-w-xs sm:max-w-md"></span>
          ...
          <div x-data="{ fileName: '' }">
            ...
            @if($asesor->file_sert_asesor)
            <div class="text-sm text-gray-600 mb-2">
                File saat ini: <a href="{{ Storage::url($asesor->file_sert_asesor) }}" target="_blank" class="text-blue-600 hover:underline">{{ basename($asesor->file_sert_asesor) }}</a>
            </div>
            @endif
            <div class="flex items-center justify-between w-full p-2.5 border border-gray-300 rounded-lg">
              <span x-text="fileName || 'Pilih file baru (opsional)'" class="text-gray-500 text-sm pl-2 truncate w-full max-w-xs sm:max-w-md"></span>
              ...
              <input type="file" id="file_sert_asesor" name="file_sert_asesor" class="hidden"
                     @change="fileName = $event.target.files[0] ? $event.target.files[0].name : ''">
            </div>
          </div>
          ...
          <div x-data="{ fileName: '' }">
            ...
            @if($asesor->file_sert_kompetensi)
            <div class="text-sm text-gray-600 mb-2">
                File saat ini: <a href="{{ Storage::url($asesor->file_sert_kompetensi) }}" target="_blank" class="text-blue-600 hover:underline">{{ basename($asesor->file_sert_kompetensi) }}</a>
            </div>
            @endif
            <div class="flex items-center justify-between w-full p-2.5 border border-gray-300 rounded-lg">
              <span x-text="fileName || 'Pilih file baru (opsional)'" class="text-gray-500 text-sm pl-2 truncate w-full max-w-xs sm:max-w-md"></span>
              ...
              <input type="file" id="file_sert_kompetensi" name="file_sert_kompetensi" class="hidden"
                     @change="fileName = $event.target.files[0] ? $event.target.files[0].name : ''">
            </div>
          </div>
