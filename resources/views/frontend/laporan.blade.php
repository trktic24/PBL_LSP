        ...
        <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-6">
                ...
                <nav class="absolute left-1/2 transform -translate-x-1/2 flex space-x-6 text-gray-700 font-medium">
                    <a href="{{ route('home') }}" class="hover:text-blue-60e">Home</a>
                    <a href="{{ route('jadwal') }}" class="hover:text-blue-600">Jadwal</a>
                    <a href="{{ route('laporan') }}" class="text-blue-600 font-semibold underline">Laporan</a>
        ...
        <table class="w-full border-collapse">
            ...
            <tbody class="text-gray-700">
                ...
                <tr class="border-b hover:bg-amber-100">
                    ...
                    <td class="py-3 px-4">
                        <span class="bg-green-200 text-green-800 px-2 py-1 rounded-full text-sm font-medium">
                            Sudah Diverifikasi
                        </span>
                    </td>
                    <td class="py-3 px-4 text-center space-x-2">
                        <!-- Tombol verifikasi abu-abu (sudah diverifikasi) -->
                        <a href="#" class="bg-gray-400 text-white px-3 py-1 rounded-md text-sm font-medium cursor-not-allowed">
                            Verifikasi
                        </a>
                        <a href="#"
                           class="bg-amber-500 hover:bg-amber-600 text-white px-3 py-1 rounded-md text-sm font-medium transition">
                           Laporan Asesmen
                        </a>
                        <a href="#"
                ...
                <tr class="border-b hover:bg-amber-100">
                    ...
                    <td class="py-3 px-4 text-center space-x-2">
                        <!-- Tombol verifikasi kuning tua (belum diverifikasi) -->
                ...
                <tr class="hover:bg-amber-100">
                    ...
                    <td class="py-3 px-4 text-center space-x-2">
                        <a hrf="#" class="bg-yellow-600 hover:bg-yellow-700 text-white px-3 py-1 rounded-md text-sm font-medium transition">
                            Verifikasi
                        </a>
                        <a href="#"
                           class="bg-amber-500 hover:bg-amber-600 text-white px-3 py-1 rounded-md text-sm font-medium transition">
