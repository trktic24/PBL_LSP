    ...
    <main class="main-content">
        <div class="p-8">
            ...
            <form class="form-body mt-6">
                <x-identitas_skema_form.identitas_skema_form skema="{{ $jadwal->skema?->nama_skema ?? 'Nama Skema' }}"
                    ...
                    namaAsesi="{{ $asesi->nama_lengkap ?? 'Nama Asesi' }}" tanggal="{{ $jadwal->tanggal_pelaksanaan  }}"
                    :showWaktu="false" />
                ...
                <div class="form-section my-8">
                    ...
                    <div class="border border-gray-900 shadow-md mb-6">
                        <div class="grid grid-cols-[100px_1fr] divide-x divide-gray-900">
                            ...
                            <ol class="list-decimal list-inside p-2 space-y-1 text-sm">
                                <li>Ajukan pertanyaan kepada Asesi dari daftar pertanyaan di bawah ini untuk mengonfirmasi
                                    pengetahuan, sebagaimana diperlukan.</li>
                                <li>Tempatkan centang di kotak pencapaian "Ya" atau "Tidak".</li>
                                <li>Tulis jawaban Asesi secara singkat di tempat yang disediakan dan konfirmasi ulang untuk
                                    setiap jawaban.</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <x-table>
                        ...
                        <tr>
                            <td class="bg-black text-white border border-gray-900 p-2 h-10 text-sm align-top text-center font-bold"
                                rowspan="3">
                    ...
                    <x-table>
                        <x-slot name="thead">
                            <tr class="bg-black text-white">
                                ...
                                <th colspan="2" class="border border-gray-900 p-2 w-32 text-sm font-semibold">Pencapaian
                                </th>
                            </tr>
                            <tr class="bg-black text-white">
                        ...
                        <tr>
                            ...
                            <td class="border border-gray-900 text-center">
                                <input type="checkbox" name="p1_ya" value="ya"
                                    class="form-checkbox h-4 w-4 text-blue-600 rounded">
                            </td>
                            <td class="border border-gray-900 text-center">
                                <input type="checkbox" name="p1_tidak" value="tidak"
                                    class="form-checkbox h-4 w-4 text-blue-600 rounded">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="border border-gray-900 px-3 py-1 text-sm font-medium">Pertanyaan:</td>
                            <td class="border border-gray-900 text-center">
                                <input type="checkbox" name="p2_ya" value="ya"
                                    class="form-checkbox h-4 w-4 text-blue-600 rounded">
                            </td>
                            <td class="border border-gray-900 text-center">
                                <input type="checkbox" name="p2_tidak" value="tidak"
                                    class="form-checkbox h-4 w-4 text-blue-600 rounded">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="border border-gray-900 px-3 py-1 text-sm font-medium">Pertanyaan:</td>
                            <td class="border border-gray-900 text-center">
                                <input type="checkbox" name="p3_ya" value="ya"
                                    class="form-checkbox h-4 w-4 text-blue-600 rounded">
                            </td>
                            <td class="border border-gray-900 text-center">
                                <input type="checkbox" name="p_tidak" value="tidak"
                                    class="form-checkbox h-4 w-4 text-blue-600 rounded">
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="form-section my-8">
                    <x-table>
                        <x-slot name="thead">
                            ...
                            <tr>
                                <td class="border border-gray-900 p-2 font-semibold w-40 bg-black text-white">Umpan balik
                                    untuk asesi</td>
