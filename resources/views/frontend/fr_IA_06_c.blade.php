...
<div class="p-8" x-data="{ showNotif: false }">
    ...
    <div x-show="!showNotif">
        ...
        <!-- ===================================================== -->
        <!-- MULAI MODIFIKASI: Box Tabel Pertanyaan (Layout Rapi)  -->
        <!-- ===================================================== -->
        <div class="mb-6">
            <div class="overflow-x-auto border border-gray-300 rounded-md shadow-sm">
                <table class="w-full text-sm">
                    <thead class="bg-gray-100">
                        <tr>
                            <!-- Judul kolom Jawaban sedikit lebih lebar -->
                            <th class="p-3 text-left font-medium w-9/12 pl-5">Jawaban</th>
                            <th class="p-3 text-center font-medium w-3/12" colspan="2">Pencapaian</th>
                        </tr>
                        <tr>
                            <!-- Kolom kosong untuk perataan -->
                            <th class="p-3 text-left font-medium"></th>
                            <th class="p-3 text-center font-medium w-[10%]">Ya</th>
                            <th class="p-3 text-center font-medium w-[10%]">Tidak</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 bg-white">
                        ...
                        @for ($i = 1; $i <= 5; $i++)
                            <tr>
                                <!-- Kolom Jawaban (Nomor + Textarea) -->
                                <td class="p-3 text-left">
                                    <!-- Flexbox untuk perataan nomor dan textarea -->
                                    <div class="flex flex-row gap-3 align-top">
                                        <span class="font-medium pt-2">{{ $i }}.</span> <!-- pt-2 agar sejajar dengan baris pertama text -->
                                        <textarea
                                ...
                                <!-- Kolom Radio "Ya" -->
                                <td class="p-3 text-center align-top pt-4"> <!-- align-top agar radio sejajar atas -->
                                    <input type="radio" name="pencapaian_{{ $i }}" value="ya" class="h-4 w-4 text-blue-600 focus:ring-blue-500">
                                </td>

                                <!-- Kolom Radio "Tidak" -->
                                <td class="p-3 text-center align-top pt-4"> <!-- align-top agar radio sejajar atas -->
                                    <input type="radio" name="pencapaian_{{ $i }}" value="tidak" class="h-4 w-4 text-red-600 focus:ring-red-500">
                                </td>
                            </tr>
                        @endfor
        ...
        <!-- ===================================================== -->
        <!-- AKHIR MODIFIKASI: Box Tabel Pertanyaan                 -->
        <!-- ===================================================== -->
