    ...
    <div class="h-screen overflow-y-auto">
        ...
        <main class="flex min-h-[calc(100vh-80px)] bg-gray-50">
            ...
            <aside class="w-1/4 p-6 bg-white shadow-lg border-r border-gray-200">
                ...
                <div class="space-y-2">
                    <a href="user_profile_settings" class="flex items-center p-3 text-sm font-medium rounded-xl text-gray-600 hover:bg-gray-100 transition">
                    ...
                    <a href="user_profile_bukti" class="flex items-center p-3 text-sm font-semibold rounded-xl bg-blue-600 text-white shadow">
