    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                @if ($data->presensi && $data->presensi->hadir == 1)
                    <div class="ttd-box">
                        <img src="{{ public_path($data->asesi->tanda_tangan) }}" style="width: 100%; height: 100%; object-fit: contain;" />
                    </div>
                @else
                    -
                @endif
...
<div class="ttd-box" style="margin: 0 auto;">
    @if($jadwal->asesor && $jadwal->asesor->tanda_tangan)
        <img src="{{ public_path($jadwal->asesor->tanda_tangan) }}" style="width: 100%; height: 100%; object-fit: contain;" />
    @endif
</div>
<br>
